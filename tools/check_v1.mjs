...
assert(config.version === "1.8.0", "tauri.conf.json version is not 1.8.0");
assert(packageJson.version === "1.8.0", "package.json version is not 1.8.0");
assert(/version = "1\.8\.0"/.test(cargo), "Cargo.toml version is not 1.8.0");
