...
assert(packageJson.version === "1.3.1" && tauriConfig.version === "1.3.1", "v1.3.1 版本号未统一");
assert(/version = "1\.3\.1"/.test(cargo), "Cargo.toml 未更新到 v1.3.1");
assert(chatJs.includes('appVersion: "1.3.1"'), "备份版本号未更新到 v1.3.1");
