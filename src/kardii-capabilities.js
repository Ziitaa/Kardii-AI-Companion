(() => {
  ...
  const LIMITATIONS = [
    ...
    "企业微信普通聊天只处理文字和已转写语音且不会自动执行；显式远程 Agent 仅限绑定账号二次确认的只读白名单，不是远程桌面，也不能创建或修改外部内容。",
